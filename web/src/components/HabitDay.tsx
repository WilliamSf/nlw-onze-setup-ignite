...
export function HabitDay({ completed = 0, amount = 0, date }: HabitDayProps) {
    const completedPercentage = completed > 0 ? Math.round((completed / amount) * 100) : 0;
            ...
            <Popover.Portal>
                <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                    ...
                    <div className='mt-6 flex flex-col gap-3'>
                        <Checkbox.Root className='flex items-center gap-3 group hover:border-transparent focus:outline-none'>
